      ...
      >
        <div className="max-w-7xl mx-auto px-6 sm:px-10 flex items-center justify-between">
          <a
            id="logo"
            href="#hero"
            className="font-unbounded text-2xl sm:text-3xl font-black tracking-tighter lowercase text-[#121214] dark:text-[#F6F6F5] transition-transform duration-300 hover:scale-105"
