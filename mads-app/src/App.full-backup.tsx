/**
 * Длинная версия лендинга до укорачивания.
 * Откат: скопировать этот файл в App.tsx, Navbar.full-backup.tsx → Navbar.tsx,
 * About.full-backup.tsx → AboutSection.tsx, затем npm run build и скопировать dist в mads/.
 */
