    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          <div>
            <h2 className="font-unbounded text-2xl sm:text-4xl md:text-5xl font-bold tracking-tight text-[#F6F6F5]">
              36 занятий. Не плейлист «посмотрите потом».
            </h2>
            <p className="mt-4 text-base sm:text-lg text-[#A1A1AA] max-w-2xl">
              24 ноября — 20 марта. Откройте список, если хотите увидеть, чем это не очередной марафон из десяти модулей.
            </p>
          </div>
        ...
        <button
          ...
          className="mb-8 w-full sm:w-auto px-6 py-3 rounded-full bg-white/10 text-white text-sm font-semibold hover:bg-white/20 transition-colors"
        >
          {isOpen ? 'Скрыть программу' : 'Открыть 36 занятий'}
        </button>
