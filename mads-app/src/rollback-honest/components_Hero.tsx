            ...
            <div className="flex items-center">
              {SPEAKERS_DATA.slice(0, 5).map((person) => (
                <img
                  ...
                  src={person.avatar}
                  alt=""
                  className="w-10 h-10 rounded-full object-cover ring-2 ring-[#F6F6F5] -ml-2 first:ml-0"
                />
              ))}
              <span className="ml-3 text-xs text-[#52525B]">
                11 практиков на курсе
              </span>
            </div>
            <button
          ...
          <div className="bg-[#121214] border border-white/10 rounded-2xl max-w-3xl w-full p-6 relative">
            ...
            <div className="aspect-video bg-black rounded-xl overflow-hidden relative mt-4 border border-white/5">
              ...
              <div className="relative text-center p-8 h-full flex flex-col items-center justify-center">
                ...
                <h4 className="font-unbounded text-lg text-white font-bold mb-2">Видео-манифест курса</h4>
                <p className="text-xs text-[#E4E4E7] max-w-md mx-auto">
                  Учебные кейсы и разборы кампаний — без чужих брендов и чужих имён.
                </p>
              </div>
            </div>
          </div>
